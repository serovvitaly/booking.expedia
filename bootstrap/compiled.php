...
class Application extends Container implements HttpKernelInterface, ResponsePreparerInterface
{
    ...
    {
        return 'D:\\OpenServer\\html\\booking.expedia\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation' . '/start.php';
    }
...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        if (!($resources = $this->getResourcesPath())) {
            $resources = 'D:\\OpenServer\\html\\booking.expedia\\vendor\\filp\\whoops\\src\\Whoops\\Handler' . '/../Resources';
        }
